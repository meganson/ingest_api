...
CommonModule.prototype.replaceBlankToString = function(str, replaceStr){
    return str.replace(/\s/g, replaceStr);
};

CommonModule.prototype.toUpperCase = function(str){
    return str.toUpperCase();
};

CommonModule.prototype.toLowerCase = function(str){
